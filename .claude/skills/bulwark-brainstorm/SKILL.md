...
**Examples:**
- `/bulwark-brainstorm "agent teams" --research logs/research/agent-teams/synthesis.md` - Brainstorm with research
- `/bulwark-brainstorm --doc plans/proposal.md` - Brainstorm from a document
- `/bulwark-brainstorm "loop detection"` - Brainstorm without prior research (warn user)
...
```
Stage 6: Diagnostics
├── Write diagnostic YAML to logs/diagnostics/bulwark-brainstorm-{YYYYMMDD-HHMMSS}.yaml
...
```fsharp
// Internal agent flow for bulwark-brainstorm
...
Write to: `logs/diagnostics/bulwark-brainstorm-{YYYYMMDD-HHMMSS}.yaml`
